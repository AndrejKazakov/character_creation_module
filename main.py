"""Программа, которая отображает действия персонажа."""
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает применение специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Возвращает результат тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает выбранный пользователем класс."""
